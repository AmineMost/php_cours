 ...
 */
 $films = ["La Ligne Verte", "The Dark Knight", "Interstellar", "Matrix", "Fairy Tail : Dragon Cry"];
...
// Supprimer le premier fruit du tableau
array_shift($fruits);
...
echo "<li> Prénom :  " . $personne['prenom'] . "</li>";
echo "<li> Nom :  " . $personne['nom'] . "</li>";
echo "<li> Âge :  " . $personne['age'] . " ans</li>";
...
// Utiliser count() pour compter les éléments
echo "Le nombre de villes est : " . count($villes) . "<br>";

// Utiliser sizeof() pour compter les éléments (identique à count())
echo "Le nombre de villes est (avec sizeof) : " . sizeof($villes) . "<br>";
